...
namespace Term {
    inline void Clear()      { fputs("\033[2J", stdout); }
    inline void Home()       { fputs("\033[H",  stdout); }
    inline void HideCursor() { fputs("\033[?25l", stdout); }
    inline void ShowCursor() { fputs("\033[?25h", stdout); }
    inline void Bold()       { fputs("\033[1m", stdout); }
    inline void Dim()        { fputs("\033[2m", stdout); }
    inline void Reset()      { fputs("\033[0m", stdout); }
    inline void Green()      { fputs("\033[32m", stdout); }
    inline void Yellow()     { fputs("\033[33m", stdout); }
    inline void Cyan()       { fputs("\033[36m", stdout); }
    inline void Red()        { fputs("\033[31m", stdout); }
}
